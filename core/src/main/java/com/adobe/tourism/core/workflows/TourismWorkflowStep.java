...
@Component(service = WorkflowProcess.class, property = { "process.label" + "= Tourism Workflow Step",
		Constants.SERVICE_VENDOR + "=AEM Tourism", Constants.SERVICE_DESCRIPTION + " = Custom tourism workflow step."

})
public class TourismWorkflowStep implements WorkflowProcess {

	private static final Logger LOG = LoggerFactory.getLogger(TourismWorkflowStep.class);
